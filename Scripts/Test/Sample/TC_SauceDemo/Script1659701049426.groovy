...
WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Checkout Your Information_postalCode'), '456789')
...
WebUI.verifyElementPresent(findTestObject('Page_Swag Labs/txt_OrderConfirmation'), 0)
